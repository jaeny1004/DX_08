...
export interface TreeRecord {
  ...
  latitude?: number;
  longitude?: number;
  /** 위경도로 역조회한 행정동명. 화면에는 좌표 대신 이 값을 쓴다. */
  emdName?: string;
  /** 위경도로 역조회한 500m 격자 ID. */
  gridId?: string;
  imageUrl?: string;
...
export const IA_DATA: IAScreen[] = [
  ...
  { "No": "47", "대메뉴": "6. 시스템 관리", "중메뉴": "모델 관리", "화면ID": "SYS-003", "화면명": "모델 버전 관리", "화면 기능 정의": "예측 모델 버전 목록 조회, 운영 모델 전환", "groupKey": "system" },
...
export const REQUIREMENTS_DATA: Requirement[] = [
  ...
  { reqId: "FR-SYS-003", name: "모델 버전 관리", screenId: "SYS-003", detail: "예측 모델 버전 목록을 조회하고, 운영 모델을 전환한다.", input: "모델 메타데이터", output: "버전 목록 테이블, 전환 버튼", nfr: "전환 시 이전 버전 자동 백업", priority: "상" },
